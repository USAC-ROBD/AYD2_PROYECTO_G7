...
CREATE TABLE TARJETA (
    ...
    CONSTRAINT CK_VENCIMIENTO_TARJETA CHECK (VENCIMIENTO > CURRENT_DATE),
...
CREATE TABLE ENCUESTA_DETALLE (
    ...
    CREACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CREA VARCHAR(50) DEFAULT 'SYSTEM',
    CONSTRAINT PK_ENCUESTA_DETALLE PRIMARY KEY (ID_ENCUESTA, ID_PREGUNTA),
    CONSTRAINT FK_ENCUESTA_DETALLE_ENCUESTA FOREIGN KEY (ID_ENCUESTA) REFERENCES ENCUESTA(ID_ENCUESTA),
    CONSTRAINT FK_ENCUESTA_DETALLE_PREGUNTA FOREIGN KEY (ID_PREGUNTA) REFERENCES PREGUNTA(ID_PREGUNTA),
