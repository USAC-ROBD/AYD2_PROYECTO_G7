...
CREATE TABLE CLAVE_SUPERVISOR (
    ...
    CREACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CREA VARCHAR(50) DEFAULT 'SYSTEM',
    CONSTRAINT FK_CLAVE_SUPERVISOR_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(ID_USUARIO)
);
...
CREATE TABLE CUENTA (
    ...
    ESTADO CHAR(1) NOT NULL DEFAULT 'A',  -- A: Activa, I: Inactiva
    CREACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CREA VARCHAR(50) DEFAULT 'SYSTEM',
    ACTUALIZACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ACTUALIZA VARCHAR(50) DEFAULT 'SYSTEM',
    ...
    CONSTRAINT CK_ESTADO_CUENTA CHECK (ESTADO IN ('A', 'I'))     -- A: Activa, I: Inactiva
);
