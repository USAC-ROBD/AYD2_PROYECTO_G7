...
![DCDU-3.1](./assets/administrador/login-administrador.png)

##### DCDU-3.2 Registrar empleado

![DCDU-3.2](./assets/administrador/creacion-empleado.png)

##### DCDU-3.3 Asignación de roles

![DCDU-3.3](./assets/administrador/asignar-rol.png)

##### DCDU-3.4 Eliminar empleados

![DCDU-3.4](./assets/administrador/eliminacion-empleado.png)

##### DCDU-3.5 Cambio de contraseña de empleado

![DCDU-3.5](./assets/administrador/cambio-password.png)

##### DCDU-3.6 Gestión de copias de seguridad

![DCDU-3.6](./assets/administrador/copia-seguridad.png)
