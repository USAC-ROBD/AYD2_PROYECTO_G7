...
export default function FormCreacionDolares() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`${import.meta.env.VITE_API_HOST}/crear_cuenta_cliente_dolares`, {
            method: "POST",
            headers: {
                ...
                <Col md={10}>
                    <Card>
                        <Card.Header className="bg-primary text-white text-center">
                            <h4>Solicitud de Nueva Cuenta en Dolares</h4>
                        </Card.Header>
                        <Card.Body>
