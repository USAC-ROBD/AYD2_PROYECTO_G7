      ...
      >
        <Col xs={12} sm={6} md={3} className="mb-3">
          <Button
            ...
            size="lg"
            className="w-100"
            onClick={() => navigate('/metodo-pago', { state: { service: 'Luz', user } })}
        ...
        <Col xs={12} sm={6} md={3} className="mb-3">
          <Button
            ...
            size="lg"
            className="w-100"
            onClick={() => navigate('/metodo-pago', { state: { service: 'Agua', user } })}
            style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}
          >
        ...
        <Col xs={12} sm={6} md={3} className="mb-3">
          <Button
            ...
            size="lg"
            className="w-100"
            onClick={() => navigate('/metodo-pago', { state: { service: 'Telefono', user } })}
            style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}
          >
        ...
        <Col xs={12} sm={6} md={3} className="mb-3">
          <Button
            ...
            size="lg"
            className="w-100"
            onClick={() => navigate('/metodo-pago', { state: { service: 'Internet', user } })}
            style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}
          >
